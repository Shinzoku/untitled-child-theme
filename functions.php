...
function my_theme_enqueue_styles() {
    ...
    // wp_enqueue_style('child-style', get_stylesheet_directory_uri().'/style.css', ['untitled-style']); // si la feuille parent prend le dessus on supprime la ligne du dessous et active ceci.
    wp_enqueue_style('child-style', get_stylesheet_directory_uri().'/style.css', ['parent-style','untitled-webfont','untitled-flex-slider-style']);
}
